...
import {InputTypeFile} from "../../common/pages/UploadFile/InputPropsType";
...
const ProfilePage = () => {
	...
	const updatePhotoHandler = (data: UploadPhotoType) => {
		data['question'] = 'ecec'
		dispatch(updateUserNameTC(data))//data -> {avatar: "base64:wirifwiuh43i3"}
	}
					...
					<div className={style.profileContainer}>
						<div className={style.profile}>
							...
							<div className={style.innerContainer}>
								...
								<InputTypeFile updatePhotoHandler={updatePhotoHandler} keyFotoField={'avatar'}>
									<IconButton
										component="span"//нужно для того чтобы иконка отображалась вместо станд кнопки
										size={'small'}
									>
